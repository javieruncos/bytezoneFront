      ...
      <div className="grid grid-cols-2 lg:grid-cols-6  px-4 md:px-0">
        <a href="/categorias/Auriculares">
          <div className="h-[130px] w-full  backgroundICons  flex items-center justify-center  flex-col menuProduct">
            ...
            <div className="absolute  top-0 left-0 w-full h-full flex items-center justify-center bg-black  hover:bg-black/60 transition-all duration-600 text-violet-600 hover:text-white">
        ...
        <a href="/categorias/Monitor">
          <div className="h-[130px] w-full  backgroundICons  flex items-center justify-center  flex-col menuProduct">
            ...
            <div className="absolute  top-0 left-0 w-full h-full flex items-center justify-center bg-black  hover:bg-black/60 transition-all duration-600 text-gray-400 hover:text-white">
