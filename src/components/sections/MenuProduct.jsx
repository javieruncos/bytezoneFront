        ...
        <div className='h-[250px]  container mx-auto px-15'> 
            <div className='grid grid-cols-6 gap-2 h-auto py-15'>
                <div className='h-[130px] w-full border border-gray-300 flex items-center justify-center rounded-2xl flex-col menuProduct'>
                    ...
                    <span className='text-black nombreOpcion text-2xl font-bold'>Teclados</span>
                </div>
                <div className='h-[130px] w-full border border-gray-300 flex items-center justify-center rounded-2xl flex-col menuProduct'>
                     <img src={auricular} alt=""  className="IconOpcion h-[60px]"/>
                    <span className='text-black nombreOpcion text-2xl font-medium'>Auriculares</span>
                </div>
                <div className='h-[130px] w-full border border-gray-300 flex items-center justify-center rounded-2xl flex-col menuProduct'>
                     <img src={joystick} alt=""  className="IconOpcion h-[80px]"/>
                    <span className='text-black nombreOpcion text-2xl font-medium'>Joystick</span>
                </div>
                <div className='h-[130px] w-full border border-gray-300 flex items-center justify-center rounded-2xl flex-col menuProduct'>
                     <img src={mouse} alt=""  className="IconOpcion h-[65px]"/>
                    <span className='text-black nombreOpcion text-2xl font-medium'>Mouse</span>
                </div>
                <div className='h-[130px] w-full border border-gray-300 flex items-center justify-center rounded-2xl flex-col menuProduct'>
                     <img src={laptop} alt=""  className="IconOpcion h-[90px]"/>
                    <span className='text-black nombreOpcion text-2xl font-medium'>laptop</span>
                </div>
                <div className='h-[130px] w-full border border-gray-300 flex items-center justify-center rounded-2xl flex-col menuProduct'>
                     <img src={monitor} alt=""  className="IconOpcion h-[80px]"/>
                    <span className='text-black nombreOpcion text-2xl font-medium'>Monitor</span>
                </div>
            </div>
        </div>
    );
