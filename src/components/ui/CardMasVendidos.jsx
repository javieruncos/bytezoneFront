  ...
  return (
    <>
      <Link to={`/detalle/${producto._id}`}>
        <div className="group w-full rounded-3xl overflow-hidden transition-all duration-500 flex flex-col md:flex-row items-center md:items-start gap-6 p-4 md:p-6 h-auto pb-10 md:h-[260px] relative backdrop-blur-xl bg-white/4 border border-white/20 shadow-[0_4px_30px_rgba(0,0,0,0.1)] hover:shadow-[0_8px_30px_rgba(0,0,0,0.2)] hover:scale-[1.02]">
          ...
          {/* Imagen */}
          <div className="relative flex-shrink-0 w-full md:w-[230px] h-[300px] md:h-[200px] flex justify-center items-center rounded-2xl overflow-hidden">
          ...
          {/* Información */}
          <div className="flex flex-col justify-between text-white w-full md:w-[calc(100%-230px)] h-auto md:h-[200px]">
            <div className="flex flex-col gap-2">
              ...
              <span className="text-xl md:text-2xl text-violet-500 font-medium">
