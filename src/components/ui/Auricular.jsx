    ...
    <>
      <div className="w-full h-full ">
        <div className="flex flex-col md:grid md:grid-cols-2 w-full h-full md:mx-5 text-center md:text-left overflow-hidden">
          ...
          <div className=" h-[300px] flex justify-center items-center md:w-[500px] md:h-full relative overflow-hidden mx-auto order-2 md:order-2 mt-10 md:mt-0">
            <motion.div
            ...
            >
              <img
                ...
                alt="Joystick Blanco"
                className="w-[250px] h-[300px]  relative object-contain top-0 left-0 md:top-0 md:left-0 md:w-full md:h-full md:absolute"
              />
              <motion.div
