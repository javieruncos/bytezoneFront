    ...
    <>
      {/* <div className="grid grid-cols-2 w-full h-full mx-5">
       ...
       <div className="w-full h-full">
          <div className="flex flex-col md:grid md:grid-cols-2 w-full h-full mx-5">
            {/* Texto animado */}
            <motion.div
            ...
            >
              <img
                src="https://cdnx.jumpseller.com/cibertech/image/58107633/g502x-plus-gallery-1-white.png?1733617661"
                alt="Joystick Blanco"
                className="w-full h-full object-contain relative top-0 left-0 md:top-0 md:left-0 md:w-full md:h-full md:absolute"
              />
              <motion.div
                initial={{ x: 100, opacity: 0 }} // empieza a la derecha
                animate={{ x: 0, opacity: 1 }} // termina en su posición
