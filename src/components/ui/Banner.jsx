...
const Banner = () => {
  return (
    <div className="container mx-auto mt-12">
      <div className="relative radialBackground rounded-md p-6 sm:p-10 md:p-16 flex flex-col md:flex-row items-center md:items-start overflow-hidden">
        <div className="w-full md:w-1/2 text-center md:text-left pt-4">
          <h2 className="text-3xl sm:text-4xl md:text-2xl lg:text-5xl font-bold text-white">
        ...
        <div className="w-full md:w-1/2 mt-6 md:mt-0 relative flex justify-center md:justify-end">
          <img
            ...
            alt="Promo"
            className="max-w-full mt-5 h-auto md:h-[300px] lg:h-[350px] object-contain md:absolute md:-top-4 lg:-top-8 md:right-0 md:mt-0"
          />
        </div>
      </div>
    </div>
