      ...
      <nav className="flex px-5 py-3 text-gray-700 border border-gray-200 rounded-lg   " aria-label="Breadcrumb">
        <ol className="inline-flex items-center space-x-1 md:space-x-3">
          <li className="inline-flex items-center">
            <a href="/" className="inline-flex items-center text-sm font-medium text-gray-700 hover:text-blue-600 dark:text-gray-400 dark:hover:text-blue-500">
          ...
          <li>
            <div className="flex items-center">
              ...
              <span className="ml-1 text-sm font-medium text-blue-500 md:ml-2 dark:text-blue-500">{categoria || "Categorias"}</span>
            </div>
          </li>
        </ol>
      </nav>
